...
#warning 请设置服务器基地址
static NSString *const kBaseURLString = @"https://kyfw.12306.cn";
...
+ (instancetype)sharedClient
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        // /先导入证书
        NSString *cerPath = [[NSBundle mainBundle] pathForResource:@"srca" ofType:@"cer"];//证书的路径  PS：使用时请将CA认证机构证书放在项目路径中
